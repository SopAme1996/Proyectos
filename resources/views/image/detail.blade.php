                  ...
                  <div class="likes col-md-4">
                    ...
                    <div class="comments">
                     <h2>Comentarios ({{count( $image->comments) }})</h2>
                        ...
                        <p>
                        <textarea name="content" id="content" cols="30" rows="10" class="form-control {{ $errors->has('content') ? 'is-invalid' : ''}}"></textarea>
                        ...
                        @foreach($image->comments as $comment)
                         <div class="comentario {{Auth::check() && $comment->user_id == Auth::user()->id ? 'format' : ''}}">
                         @if(Auth::check() && $comment->user_id == Auth::user()->id)
                         <a href="{{ route('comment.delete', ['id' => $comment->id]) }}"><i class="fas fa-plus-circle"></i></a>
                         @endif
                          <div>
                           <span
